...
Я помогу вам быстро находить информацию в ваших документах. Вот что можно сделать:
`/help` - Открыть руководство
`/token [ваш_токен]` - Установить ваш персональный токен доступа
`/documents` - Показать список ваших документов

Просто задайте вопрос в свободной форме после установки токена, например:
