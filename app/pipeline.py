...
class RAGOpenAiPipeline:
    ...
    def _preprocess_query(self, user_query: str) -> str:
        ...
        1. Удаляет лишние фразы (приветствия, вежливости и т.д.)
        2. Преобразует запрос в набор ключевых тегов/фраз
        3. Возвращает очищенный запрос для ретривера
        ...
        Исправляй явные ошибки в написании.
